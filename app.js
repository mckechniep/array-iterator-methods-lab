...
let inventorNamedAda = inventors.find(isAda);
...
let isAdultPresent = (dev) => dev.year > 2002;
// console.log(devs.some(isAdultPresent));

// Complete the exercise in the space below:

// Check your work:
console.log("Exercise 6 my result: ", devs.some(isAdultPresent));
...
let isEveryone19OrOlder = (dev) => dev.year >= 2003;
// console.log(devs.every(isEveryone19OrOlder));

// Complete the exercise in the space below:

// Check your work:
console.log("Exercise 7 my result: ", devs.every(isEveryone19OrOlder));
...
let commentById = comments.find(({ id }) => id === 823423);
...
*/
// comments.findIndex(checkId)
// function checkId(id) {
//   return id === 123523;
// }

let idx = comments.findIndex((specificId) => specificId.id === 123523);
